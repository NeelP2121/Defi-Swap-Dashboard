...
// import { dogeAbi, linkAbi, usdcAbi, daiAbi, daiAddress} from '../lib/constants'
...
//         if(toToken === 'Doge') return dogeAbi
//     }
...
//             if(fromToken === toToken) return alert('cannot swap between same tokens')
